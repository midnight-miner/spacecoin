...
// Added support for miniupnpc 1.9.20150730
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SpaceCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("spacecoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("spacecoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("spacecoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("spacecoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SpaceCoin is probably already running."), addrBind.ToString().c_str());
        else
